...
class CI_Cart
{
    ...
    function insert($items = array())
    {
        ...
        // or multiple accounts using a multi-dimensional one. The way we
    ...
    function _insert($items = array())
    {
        ...
        // a particular product, but makes it possible to store identical accounts with different options.
