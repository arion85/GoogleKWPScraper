    ...
    public function index()
    {
        ...
        if ($search_string !== false && $order !== false || $this->uri->segment(3) == true) {
            ...
            */
            ...
            if ($search_string) {
                if ($order) {
                    $data['countries'] = $this->manufacturers_model->get_manufacturers($search_string, $order, $order_type, $config['per_page'], $limit_end);
                } else {
                    $data['countries'] = $this->manufacturers_model->get_manufacturers($search_string, '', $order_type, $config['per_page'], $limit_end);
                }
            } else {
                if ($order) {
                    $data['countries'] = $this->manufacturers_model->get_manufacturers('', $order, $order_type, $config['per_page'], $limit_end);
                } else {
                    $data['countries'] = $this->manufacturers_model->get_manufacturers('', '', $order_type, $config['per_page'], $limit_end);
                }
            }
